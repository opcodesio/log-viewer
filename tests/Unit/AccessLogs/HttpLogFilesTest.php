...
beforeEach(function () {
    ...
    File::put(
        $this->access_dummy_log_path = storage_path('logs/http/access_dummy.log'),
        file_get_contents(__DIR__.'/Fixtures/access_dummy.log')
    );
    File::put(
        $this->error_dummy_log_path = storage_path('logs/http/errors_dummy.log'),
        file_get_contents(__DIR__.'/Fixtures/errors_dummy.log')
    );
    File::put(
        $this->error_nginx_dummy_log_path = storage_path('logs/http/errors_nginx_dummy.log'),
