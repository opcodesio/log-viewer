...
Route::prefix('api')->group(function () {
    ...
    Route::delete('folders/{folderIdentifier}', 'FoldersController@destroy')->name('log-viewer.folders.destroy');
    ...
    Route::delete('files/{fileIdentifier}', 'FilesController@destroy')->name('log-viewer.files.destroy');
