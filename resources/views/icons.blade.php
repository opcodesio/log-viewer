<svg style="display: none">
    <defs>
        ...
        <symbol id="icon-trashcan" viewBox="0 0 20 20">
            <path fill-rule="evenodd"
        ...
        <symbol id="icon-checkmark" viewBox="0 0 18 18">
            <path
                d="M11.9393398,6 C12.232233,5.70710678 12.7071068,5.70710678 13,6 C13.2928932,6.29289322 13.2928932,6.76776695 13,7.06066017 L7.5,12.5606602 L5,10.0606602 C4.70710678,9.76776695 4.70710678,9.29289322 5,9 C5.29289322,8.70710678 5.76776695,8.70710678 6.06066017,9 L7.5,10.4393398 L11.9393398,6 Z"></path>
        </symbol>
        ...
        <symbol id="icon-theme-auto" viewBox="0 0 20 20">
            <path fill-rule="evenodd"
                  d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z"
                  clip-rule="evenodd" />
        </symbol>
        <symbol id="icon-theme-dark" viewBox="0 0 20 20">
            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
        </symbol>
        <symbol id="icon-theme-light" viewBox="0 0 20 20">
            <path fill-rule="evenodd"
