<button title="Share this page" class="relative ml-5 p-2 text-gray-400 group hover:text-gray-500 cursor-pointer"
    ...
    <span class="absolute -top-3 -right-1 text-xs hidden group-hover:block whitespace-nowrap"><span x-show="!copied">Share this page</span><span x-show="copied" class="text-emerald-600">Copied!</span></span>
</button>
