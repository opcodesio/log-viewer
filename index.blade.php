...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('vendor/log-viewer/img/log-viewer-32.png') }}">

    <title>Log Viewer{{ config('app.name') ? ' - ' . config('app.name') : '' }}</title>

    <!-- Style sheets-->
    <link href="{{ asset('vendor/log-viewer/app.css') }}" rel="stylesheet"
...
<body class="h-full px-3 lg:px-5 bg-gray-100 dark:bg-gray-900">
    ...
    <script src="{{ asset('vendor/log-viewer/app.js') }}"
